...
site_activity <- read_csv(here("supplemental_materials", "tidy_data", "site_activity.csv"))
...
for (i in unique(DI_cpue_site_activity$site_id)) {
  ...
  ggsave(cpue_site, 
         filename = here("./supplemental_materials/figs/cpue_site_activity", file=paste0("plot_", i,".png")))
}
...
ggsave(DI_cpue, filename = here("./supplemental_materials/figs/cpue_site_activity", file=paste("DI_cpue", ".png")))
...
ggsave(DI_mean_schoolsize, filename = here("./supplemental_materials/figs/cpue_site_activity", 
...
ggsave(DI_total_schoolsize, filename = here("./supplemental_materials/figs/cpue_site_activity", 
...
ggsave(plot_observations_catch, filename = here("./supplemental_materials/figs/cpue_site_activity", 
...
ggsave(plot_mean_activity_catch, filename = here("./supplemental_materials/figs/cpue_site_activity", 
...
ggsave(plot_netset_catch, filename = here("./supplemental_materials/figs/cpue_site_activity", 
...
ggsave(sockeye_plot, filename = here("./supplemental_materials/figs/cpue_site_activity", file=paste("SO_by_Slider_Activity", ".png")))
```
