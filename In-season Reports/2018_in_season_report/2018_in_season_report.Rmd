---
title: "2018 Hakai Institute Juvenile Salmon Program Report"
output:
...
![Salmon sampling locations in the Discovery Islands and Johnstone Strait in 2018 (yellow circles).](./figs/map_2018.jpg)
...
```{r All stages Lice Abundance, fig.cap= "The abundance ± SE of all three developmental stages of combined _Lepeoptheirus salmonis_ and _Caligus clemensi_ sea lice  per juvenile sockeye salmon in 2018."}
...
```{r Lice cal intensity, echo = FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = "The mean infection intensity of __motile__ _Caligus clemensi_ sea lice per juvenile sockeye salmon infected with one or more motile _Caligus clemensi_ in 2018."}
...
```{r Lice lep intensity, echo = FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = "The mean intensity of __motile__ _Lepeoptheirus salmonis_ sea lice per juvenile sockeye salmon infected with one or more motile _Lepeoptheirus salmonis_ in 2018."}
...
```{r nsog DI CTD temp, fig.cap = "Oceanographic time series in the Discovery Islands and the Northern Strait of Georgia from averaged from the top 30 m "}
