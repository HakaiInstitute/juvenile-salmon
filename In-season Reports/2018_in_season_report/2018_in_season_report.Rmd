...
```{r Sockeye abundance, fig.cap="Average number of juvenile sockeye salmon caught in each seine in 2018 averaged over one week periods for each region and represented by the middle day of each week."}
...
## Fish Lengths
```{r DI Length Histogram, echo = FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = "Fork legnth boxplots of juvenile salmon in the Discovery Islands in 2018 grouped by week, and represented by the middle day of each week, compared to the average length from 2015, 2016 and 2017."}
...
```{r JS Length Histogram, echo = FALSE, warning=FALSE, message=FALSE, error=FALSE, fig.cap = "Fork legnth boxplots of juvenile salmon in Johnstone Strait in 2018 grouped by week, and represented by the middle day of each week, compared to the average length from 2015, 2016 and 2017."}
...
```{r secchi bloom timing, fig.cap = "Secchi depth at station QU39 in the Northern Strait of Georgia in 2018 indicating a spring phytoplankton bloom in mid-March."}
