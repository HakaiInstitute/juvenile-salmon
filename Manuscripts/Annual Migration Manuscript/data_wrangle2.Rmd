...
library(lubridate)
library(car)
library(hakaisalmon) # v 0.2.0
library(hakaiApi)

# The hakaisalmon R package has loaded into memory all the data tables from
#  the database. 
survey_seines <- hakaisalmon::survey_seines%>%
  mutate(year = year(survey_date)) %>% 
  # constrain the analysis to the time period that was sampled every year
