...
CU_api_mean <- mean(CU_api_annual_mean$prevalence)
CU_api_sd <- sd(CU_api_annual_mean$prevalence)
    
CU_api_z <- (CU_api_annual_mean$prevalence - CU_api_mean) / CU_api_sd
