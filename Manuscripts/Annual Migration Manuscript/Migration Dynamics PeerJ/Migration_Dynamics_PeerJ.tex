...
\begin{figure}
\includegraphics[width=1\linewidth]{Migration_Dynamics_PeerJ_files/figure-latex/results-1} \caption{In-text Picture}\label{fig:results}
\end{figure}
