...
di_sim_set <- tibble("2015" = rnorm(100000, di_mean_date_2015, di_sd_2015),
                      "2016" = rnorm(100000, di_mean_date_2016, di_sd_2016),
                      "2017" = rnorm(100000, di_mean_date_2017, di_sd_2017),
                     "region" = "DI") %>% 
  gather(`2015`, `2016`, `2017`, key = "year", value = "yday")

js_sim_set <- tibble("2015" = rnorm(100000, js_mean_date_2015, js_sd_2015),
                      "2016" = rnorm(100000, js_mean_date_2016, js_sd_2016),
                      "2017" = rnorm(100000, js_mean_date_2017, js_sd_2017),
                     "region" = "JS") %>% 
  gather(`2015`, `2016`, `2017`, key = "year", value = "yday")
...
ggplot(sim_set, aes(x = yday, y = region, fill = region)) +
  ...
  ggtitle("Peak sockeye migration")
ggsave(here::here("figs", "ndist_migration_date.png"))
...
# TODO calculate average difference in days between regions
...
ggplot(annual_cpue, aes(x = year, y = mean, fill = species)) +
