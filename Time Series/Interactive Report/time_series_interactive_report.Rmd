...
package_data <- read_csv("package_data.csv")
sealice_field <- read_csv("sealice_field.csv")
...
ysi <- read_csv("ysi.csv")
zoop_tows <- read_csv("zoop_tows.csv")

date_order <- c("May 5", "May 12", "May 19", "May 26", "June 2", "June 9",
                "June 16", "June 23", "June 30", "July 6", "July 13")

survey_data$sampling_week <- factor(survey_data$sampling_week, levels = date_order)
