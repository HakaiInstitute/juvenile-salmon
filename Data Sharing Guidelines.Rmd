...
4. Each table should have only one 'type' of variables (eg. length measurements stored seperately from weather), each table should include a common column that allows them to be joined. This collection of tidy data tables forms a tidy data set.
