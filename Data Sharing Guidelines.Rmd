...
survey.id | date | sea.state | cloud.cover | temp.0m | temp.1m
--- | --- | --- | --- | --- | ---
...
The top row of each column should be a header, and follow an unambiguous naming scheme, e.g. `ageclass` instead of `AC`. Do not use spaces in column header names (periods or underscores are acceptable), and avoid capitalization.
