...
ggplot(gsi_okisollo, aes(x = org, y = proportion, fill = collapsed_fraser_stocks)) +
...
ggsave(here::here("figs", "annual_gsi.png"), width = 9, height = 6)
...
hakai_chilko_prop <- gsi_okisollo_2015 %>% 
  filter(org == "hakai") %>% 
  mutate(n = proportion * 10)



dfo_chilko_prop <- gsi_okisollo_2015 %>% 
  filter(org == "DFO") %>% 
  mutate(n = proportion * 10)

hakai_n <- hakai_chilko_prop$n
dfo_n <- dfo_chilko_prop$n

v <- (hakai_n - dfo_n)^2/dfo_n
chisq <- sum(v[1:11])
chisq
...
ggsave(here::here("figs", "chilko_lengths_weekly_boxplot.png"))
```
...
ggsave(here::here("figs", "shuswap_weekly_lengths_boxplot_2016.png"))
```

No significant difference in the length of hakai and dfo shuswap sockeye
...
ggsave(here::here("figs", "2015_sockeye_diff_trend.png"))
...
ggsave(here::here("figs", "sockeye_weekly_boxplot.png"), width = 8, height = 5)
...
ggsave(here::here("figs", "2016_sockeye_diff_trend.png"))
...
ggsave(here::here("figs", "sockeye_length_trends.png"), width = 12)
...
ggsave(here::here("figs", "chum_trend_2015.png"))
...
```{r 2015 lengths}
dfo_2015 <- as.numeric(all_CU_by_week_by_org_2015$DFO)
hakai_2015 <- as.numeric(all_CU_by_week_by_org_2015$hakai)
...
ggsave(here::here("figs", "chum_trend_2016.png"))
...
```{r 2016 lengths}
dfo_2016 <- as.numeric(all_CU_by_week_by_org_2016$DFO)
hakai_2016 <- as.numeric(all_CU_by_week_by_org_2016$hakai)
...
ggsave(here::here("figs", "chum_length_trend.png"), width = 12)
```
...
ggsave(here::here("figs", "fork_length_barplot.png"), width = 8, height = 7)
```
...
ggsave(here::here("figs", "KDE_map.png"))
