...
dates_worth_comparing <- full_join(dfo_same_date, hakai_same_date_summary, by = "survey_date") %>% 
  drop_na(n) %>% 
...
# I didn't get the package IDs to populate, which may be because these fish 
# never assigned a package_ID or for some other reasion

rm(dfo_same_date, hakai_okisollo, hakai_same_date, dates_worth_comparing, same_date, hakai_so, summary_same_date)
```
...
TODO Consider what type of statistical test to use to classify difference in proportions. 
